...
<head>
    ...
    <title>Мышки и клавиатуры</title>
</head>
<body>
    <div class="menu-up">
        ...
        <h1 class="page-title">Мышки и клавиатуры</h1>
    </div>
    <div class="forms-container">
        ...
        <?php
            ...
            echo "<p style='color: white; text-align: center;'>Периферийные устройства не найдены</p>";
        }
        $conn->close();
        ?>
    </div>
